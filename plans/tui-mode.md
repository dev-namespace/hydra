...
- [ ] Create `src/tui/ui.rs` with ratatui rendering
...
- [ ] Create `src/tui/input.rs` with keyboard handling
...
- [ ] Integrate PTY output polling with ratatui event loop
...
- [ ] Add `tui` subcommand to CLI in `src/main.rs`
